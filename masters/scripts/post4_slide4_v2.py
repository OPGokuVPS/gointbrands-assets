#!/usr/bin/env python3
"""Regenerate POST 4 slide 4 (close): cups instead of wine glasses + distinct scenery
(cozy veranda/brunch, NOT a city skyline) to avoid repeating the skyline from slide 1.
"""
...
prompt=("A cozy Mediterranean-style veranda brunch in Panama at soft late-afternoon light: two "
 "warm ceramic cups of wine toasting (NOT glass stemware), one red and one sparkling, side by side "
 "over a table set with light healthy food (fresh fruit, green leaves, nuts, crackers). A bottle of "
 "Conscious red wine and a Conscious sparkling bottle rest on the warm cream linen table. Tropical "
 "plants and white daisies frame the scene; a soft, unfocused green-garden/veranda backdrop (clearly "
 "NOT a city skyline). Warm gentle light, shallow depth of field, high-end editorial wellness-focused "
 "beverage photography. Reproduce the Conscious labels faithfully. No added text.")
